                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <form:input path="parent.name" cssClass="form-control" placeholder="请选择" readonly="true" data-toggle="modal"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input path="sortOrder" cssClass="form-control required " placeholder="分类排序"/>
                                    </div>
                                </div>
